...
He obtained his Ph.D. degree from Huazhong University of Science and Technology (supervised by Prof. You Yang), Master degree from Harbin Engineering University (supervised by Prof. <a href="http://cisse.hrbeu.edu.cn/info/1088/3385.htm" target="_blank">Chengtao Cai</a>) Bachelor degree from Shanghai University.
...
🚀 &nbsp; We are building a Universal Modality Learning Framework by Byte-based-LLMs for breaking the Modality Barrier, serving as a digital world simulators by performing perception and understanding on byte domain.<br>
